...
urlpatterns = [
    ...
    # Frontend Views
    path('', TemplateView.as_view(template_name='search_benchmarking/dashboard.html'), name='dashboard'),
    path('dashboard/', TemplateView.as_view(template_name='search_benchmarking/dashboard.html'), name='dashboard'),
    path('query-sets/', TemplateView.as_view(template_name='search_benchmarking/query_sets.html'), name='query_sets'),
    path('executions/', TemplateView.as_view(template_name='search_benchmarking/executions.html'), name='executions'),
           path('executions/<int:execution_id>/', TemplateView.as_view(template_name='search_benchmarking/execution_detail.html'), name='execution_detail'),
           path('query-sets/<int:query_set_id>/', TemplateView.as_view(template_name='search_benchmarking/query_set_detail.html'), name='query_set_detail'),
           path('reports/', TemplateView.as_view(template_name='search_benchmarking/reports.html'), name='reports'),
